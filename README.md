...
<img src="https://skillicons.dev/icons?i=html,css,js,php,py,dart,react,tailwind,bootstrap,threejs,laravel,nodejs,mysql,firebase,figma,git,github,vscode,postman&theme=dark" />
...
|---|:---:|---|
| **RAG Pipelines** | ⭐⭐⭐⭐⭐ | Line-level document chunking, embedding generation, retrieval-augmented answer synthesis |
| **Vector Search** | ⭐⭐⭐⭐⭐ | Pinecone DB, 768-dimension vector stores, semantic similarity search |
| **Generative AI Integration** | ⭐⭐⭐⭐☆ | Gemini 2.0 AI/Vision API, Groq API integration, prompt engineering |
| **Computer Vision** | ⭐⭐⭐⭐☆ | Real-time gaze tracking, multi-person detection, object detection pipelines |
| **Document Intelligence** | ⭐⭐⭐⭐☆ | Gemini Vision OCR, LaTeX/MathJax rendering for technical documents |
...
![Office Management](https://img.shields.io/badge/Office%20Management-Certified-7C3AED?style=for-the-badge&logo=googledocs&logoColor=white)
![Python](https://img.shields.io/badge/Python%20Programming-Certified-7C3AED?style=for-the-badge&logo=python&logoColor=white)
![HTML](https://img.shields.io/badge/HTML%20for%20Beginners-Certified-7C3AED?style=for-the-badge&logo=html5&logoColor=white)
...
<img src="https://raw.githubusercontent.com/seharfatima433/seharfatima433/output/github-contribution-grid-snake-dark.svg" width="100%"/>
