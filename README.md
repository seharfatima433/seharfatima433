...
- 💬 Ask me about **Laravel, React, Node.js, or Flutter**
- 🚀 I build web apps end-to-end — UI, backend, deployment
- 🤖 I also bring **AI features** (Gemini, RAG, vector search) into web projects
- 🎓 Studying BS-IT @ Baba Guru Nanak University (2026)
- 🎯 Open to: Full-Stack Web Developer Roles · Freelance Web Projects
